...
function [str,phi] = levelset88_2(nelx,nely,Vmax,tau)
...
F(2*(nely+1):2*(nely+1):2*(nely+1)*(round(nelx/32)+1),1) = 1;
fixeddofs = [1:2:2*(nely+1) 2*(nely+1)*(nelx+1-round(nelx/32)):2*(nely+1):2*(nely+1)*(nelx+1)];
